...
//        // Setup
//        UserRequest request = new UserRequest(TEST_USERNAME, TEST_PASSWORD, TEST_ROLE, null);
...
//
//        // Mocking
//        when(jtwUtils.generateToken(TEST_USERNAME, TEST_ROLE, null)).thenReturn(TEST_TOKEN);
...
//        verify(jtwUtils).generateToken(TEST_USERNAME, TEST_ROLE, null);
//    }
//
//    @Test
//    void login_Success() {
