...
public record ViaturaRequest
        (
                ...
                @NotBlank(message = "Campo placa não pode estar vazio")
                String placa,

                @NotBlank(message = "Campo modelo não pode estar vazio")
                String modelo,
                ...
                @NotBlank(message = "O tipo de viatura é requerido")
                String tipoViatura,

                @NotBlank(message = "O status operacional é requerido")
                String statusOperacional,

                @NotNull(message = "O campo base não pode ser vazio")
                @Positive(message = "Esta base não existe")
                Long idBase
        ) {
