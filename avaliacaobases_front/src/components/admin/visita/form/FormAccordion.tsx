...
export const FormAccordion = ({ form, expanded, onChange, onEdit, onDelete, children, summaryContent }: FormAccordionProps) => {
    const formKey = form.id?.toString() || form.categoria;

    return (
        <Accordion key={formKey} expanded={expanded} onChange={onChange} elevation={2}>
